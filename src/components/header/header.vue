   ...
   <div class="header">
      <div class="content-wrapper">
          ...
          <div class="content">
            ...
            <!-- 传递到props中也就是undefined,所以当为空时，内容就不显示 -->
            <!--  -->
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .header
    ...
    .bulletin-wrapper
      ...
      //font-size 0  去除留白,但是会影响后面的省略号,直接删除span之间的留白
      .bulletin-title
        display inline-block
        vertical-align top
        margin-top 7px
    ...
    .detail
      ...
      .detail-wrapper
        ...
        .detail-main
          margin-top 64px
          padding-bottom 64px  //  内容撑开一定高度给关闭符号 64+64(font-size)
          .name
            line-height 16px
            text-align center
            font-size 16px
